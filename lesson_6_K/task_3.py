...
def test_shop_form(chrome_browser):
    ...
    chrome_browser.find_element(By.ID, "first-name").send_keys("Irine") 
    chrome_browser.find_element(By.ID, "last-name").send_keys("Pichkobiy")
    chrome_browser.find_element(By.ID, "postal-code").send_keys("550033")
